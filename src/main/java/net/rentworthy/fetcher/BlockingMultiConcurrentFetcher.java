...
import net.rentworthy.fetcher.exception.FetcherErrorCallback;
import net.rentworthy.fetcher.exception.FetcherException;
import net.rentworthy.fetcher.exception.FetcherNotReadyException;
import net.rentworthy.fetcher.exception.FetcherTimeoutCallback;
...
class BlockingMultiConcurrentFetcher<T> implements MultiFetcher<T> {
    ...
    public BlockingMultiConcurrentFetcher(final NonBlockingConcurrentFetcher<T>... fetchers) {
        this(BlockingMultiConcurrentFetcher.DEFAULT_ERROR_CALLBACK,
             ...
             BlockingMultiConcurrentFetcher.DEFAULT_MAX_TIME_MS,
             fetchers);
    }
