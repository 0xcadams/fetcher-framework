...
public final class MultiFetchers {
  ...
  @SafeVarargs
  public final static <T> MultiFetcher<T> getMultiConcurrentFetcher(final Fetcher<T>... fetchers) {
    return MultiFetchers.getMultiConcurrentFetcher(Fetchers.getExecutorServiceFetcher(), fetchers);
  }
